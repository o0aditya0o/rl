...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="PPO training on CartPole-v1")
    ...
    parser.add_argument("--log_dir", type=str, default="Project 1/logs/cartpole")
...
def main() -> None:
    ...
    try:
        ...
        torch.save(model.state_dict(), "Project 1/checkpoints/cartpole_ppo.pt")
    finally:
        logger.close()
        env.close()
        eval_env.close()
